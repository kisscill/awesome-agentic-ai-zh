...
<p><em>结构化 7 阶段学习路径，从「LLM 是什么、token 怎么算」一路到 multi-agent 编排、本地部署，<br/>每阶段都有必做的 Hello-X 练习、必修阅读、精选 project</em></p>
...
本 repo 把网上散落各处的高质量项目、教材、Hello-X demo、必修阅读收集起来，按“从零开始、循序渐进”的顺序整理成 7 个阶段——每阶段都会清楚指出“该学什么、必做哪些 Hello-X 练习、推荐哪几个 project、进入下一阶段前该检查什么”。
...
- 🛠️ **必做 Hello-X 练习** — 每阶段都有 1-5 个 mini project（题目 + 成功标准，**自己动手写**），光看不练不算学会
